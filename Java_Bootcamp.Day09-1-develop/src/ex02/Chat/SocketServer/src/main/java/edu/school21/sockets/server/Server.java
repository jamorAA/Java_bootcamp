...
public class Server {
    ...
    @Autowired
    public Server(UserService userService, ChatRoomService chatRoomService) {
    ...
    public void start(int port) throws IOException {
        ...
        try {
            while (true) {
                ...
                ThreadConnection threadConnection =  new ThreadConnection(socket, userService, chatRoomService);
